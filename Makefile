...
install :; forge install Cyfrin/foundry-devops@0.0.11 --no-commit && forge install foundry-rs/forge-std@v1.5.3 --no-commit && forge install openzeppelin/openzeppelin-contracts@v5.0.0 --no-commit
...
deploy:
	@forge script script/Token.s.sol:TokenScript $(NETWORK_ARGS)
